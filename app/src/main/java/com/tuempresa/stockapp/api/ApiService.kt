...
interface ApiService {
    ...
    @DELETE("products/{id}") fun deleteProduct(@Path("id") id:Int): Call<Void>
    ...
    @DELETE("categories/{id}") fun deleteCategory(@Path("id") id:Int): Call<Void>
    ...
    @DELETE("suppliers/{id}") fun deleteSupplier(@Path("id") id:Int): Call<Void>
    ...
    @DELETE("clients/{id}") fun deleteClient(@Path("id") id:Int): Call<Void>
    ...
    @DELETE("purchases/{id}") fun deletePurchase(@Path("id") id:Int): Call<Void>
    ...
    @DELETE("sales/{id}") fun deleteSale(@Path("id") id:Int): Call<Void>
